  ...
  return (
    <div className="mx-auto max-w-7xl px-6 py-8">
      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-2">
        ...
        {/* Diversity Insights */}
        <Card className="lg:col-span-2">
          <CardHeader><CardTitle>Diversity Insights</CardTitle></CardHeader>
          <CardContent>
            {analytics.diversity_alerts === 0 ? (
              <p className="text-sm text-slate-500">No diversity alerts detected. Run ranking to generate insights.</p>
            ) : (
              <div className="rounded-lg bg-amber-50 p-4">
                <p className="font-medium text-amber-800">{analytics.diversity_alerts} diversity alert(s) detected</p>
                <p className="mt-1 text-sm text-amber-700">
                  Review the dashboard for educational and employer concentration alerts.
                </p>
              </div>
            )}
          </CardContent>
